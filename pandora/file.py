...
class File:
    ...
    def md5(self) -> str:
        ...
        if self._md5 is None and self.data:
            self._md5 = hashlib.md5(self.data.getvalue()).hexdigest() if self.data is not None else None  # nosec B324
    ...
    def sha1(self) -> str:
        ...
        if self._sha1 is None and self.data:
            self._sha1 = hashlib.sha1(self.data.getvalue()).hexdigest() if self.data is not None else None  # nosec B324
